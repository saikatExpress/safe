...
<body>
    ...
    <header>
        ...
        <div class="fixed_header" id="myHeader">

            <div class="header_item">

                <div class="logo_item">
                    <div class="logo_images">
                        <img src="images/logo.jpg" alt="no images">
                    </div>
                </div>
                ...
                <div class="header_item_menu">
                    ...
                    <div class="item_menu_list">
                        <a href="../safe/viewsFile/about.php">About</a>
                    </div>

                    <div class="item_menu_list">
                        <a href="../safe/viewsFile/contact.php">Contact</a>
                    </div>

                    <div class="item_menu_list">
                        <a href="../safe/viewsFile/helpline.php">Help Line</a>
                    </div>
                </div>
